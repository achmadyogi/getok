...
class DatumTransformation {
    ...
    public static function ReadDataPoints(int $idSurvey, int $idSys, int $structure, string $delimiter, string $hemi = null,
                                          int $zone = null, float $meridianCentral = null): bool {
